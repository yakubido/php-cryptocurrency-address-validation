...
class ValidatorTest extends TestCase
{
    ...
    public function currencyAddressProvider(): array
    {
        return [
            ...
            'Dogecoin #4' => [CurrencyEnum::DOGECOIN, 'testnet', true, 'n3TZFrdPvwGqfPC7vBb8PGgbFwc1Cnxq9h'],
            'Dogecoin #5' => [CurrencyEnum::DOGECOIN, 'testnet', false, 'nd5N1KW1waCicK1vqfwtTcBSbQCHBLv2Um'],
            ...
            'Dogecoin #9' => [CurrencyEnum::DOGECOIN, 'regtest', true, 'mketxxXxaBeH7AhCBMatdH5ATVad2XHQdj'],
            'Dogecoin #10' => [CurrencyEnum::DOGECOIN, 'regtest', false, 'DFrGqzk4ZnTcK1gYtxZ9QDJsDiVM8v8gwV'],
            'Dogecoin #11' => [CurrencyEnum::DOGECOIN, 'regtest', false, 'nnTZLtsXx6hdzCmmPCqt763cGF5CumeRXv'],
            //
